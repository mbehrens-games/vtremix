...
enum
{
  ...
  SCREEN_STANDARD_OPTIONS_CHOICE_BRIGHTNESS,
  SCREEN_STANDARD_OPTIONS_CHOICE_UPSCALING_MODE,
  SCREEN_STANDARD_OPTIONS_CHOICE_MORE_OPTIONS,
  SCREEN_STANDARD_OPTIONS_NUM_CHOICES
};

enum
{
  SCREEN_MORE_OPTIONS_CHOICE_SOUND_VOLUME = 0,
  SCREEN_MORE_OPTIONS_CHOICE_GAMEPAD_NUMBER,
  SCREEN_MORE_OPTIONS_CHOICE_GAME_BUTTONS,
  SCREEN_MORE_OPTIONS_CHOICE_MENU_BUTTONS,
  SCREEN_MORE_OPTIONS_CHOICE_MENU_KEYS,
  SCREEN_MORE_OPTIONS_NUM_CHOICES
};
